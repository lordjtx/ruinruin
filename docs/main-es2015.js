...
let AppComponent = class AppComponent {
    constructor() {
        ...
        this.charIGN = '';
        this.randMethod = ['pressedAndromeia', 'pressedAntisora99', 'pressedAswraith', 'pressedDrewzerr', 'pressedDumberto',
